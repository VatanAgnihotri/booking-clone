...
const products = [
  ...
  },
  {
    ...
    description: "Your customer's data will be safe & secure",
    href: "#",
...
function Header() {
  ...
  return (
    <header className="bg-[#013B94]">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between gap-x-44 p-6 lg:px-8"
        aria-label="Global"
      >
        <div>
      ...
      >
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
